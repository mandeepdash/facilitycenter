  ...
  <section class="hoc container clear">
    <div class="points group"> 
      ...
      <div class="sectiontitle">
        ...
        <h1 class ="heading font-x3">As Faculty Register Here</h1>
      </div>
	...
	<div class="row">
        ...
        <div class="col-md-6">
        	<form class="form-horizontal" role="form" method="get" action="faculty_reg" >
                <div class="form-group">
                  <label class="control-label col-sm-4" for="email">Employee ID:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="employeeid" id="employeeid" placeholder="Enter  employee id" required="required">
                  </div>
                  ...
                  <div class="col-sm-5">
                    <input type="password" class="form-control" name="pwd" id="city_name" placeholder="Enter password" required="required">
                  </div>
                  <div class="col-sm-3"></div>
                </div>
                    <div class="form-group">
                  ...
                  <div class="col-sm-3"></div>
                    ...
                    <div class="form-group">
                  <label class="control-label col-sm-4" for="email">Experience(years):</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="experience" id="experience" placeholder="Enter your experience" required="required">
                  </div>
                  <div class="col-sm-3"></div>
                </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="email" id="email" placeholder="Enter your email id" required="required">
                  </div>
                  <div class="col-sm-3"></div>
                </div>
                    <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="contactno" id="contactno" placeholder="Enter your contact no" required="required">
                  </div>
                        <div class="col-sm-3"></div>
                </div>
                ...
                <div class="form-group">        
                  <div class="col-sm-offset-4 col-sm-2">
                     <input type="submit" class="btn btn-success" name="Register" value="Register" style="cursor:pointer;" />
                  </div>
                </div>
            </form>
        </div>
