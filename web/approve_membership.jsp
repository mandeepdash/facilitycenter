  ...
  <section class="hoc container clear">
    <div class="points group"> 
      ...
      <div class="sectiontitle">
        ...
        <h1 class ="heading font-x3">Approve Membership</h1>
      </div>
	...
	<div class="row">
        ...
        <div class="col-md-6">
        	<form class="form-horizontal" role="form" method="get" action="approve_membershipdetail.jsp" >
        ...
        <div class="form-group">
                  ...
                  <div class="col-sm-offset-4 col-sm-2">
                     <input type="submit" class="btn btn-success" name="Register" value="Get requests" style="cursor:pointer;" />
                  </div>
                </div>
