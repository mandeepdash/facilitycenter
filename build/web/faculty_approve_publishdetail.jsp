...
//String regdno=(String)session.getAttribute("regno");
  String utype=request.getParameter("share_with");         
            ...
            String sql="select * from  PUBLISH_DOCUMENT1 where STATUS=0 and SHARE_WITH='faculty'";
        ...
        <tr>
            <td><%=docid%></td>
             <td><%=doccategory%></td>
              <td><%=sharewith%></td>
               <td><%=privilages%></td>
               <td><a href="faculty_publishdocument_approve.jsp?docid=<%=docid%>"><img src="images/approve-icon.jpg" style="width:20px;"border="0" title="publish" /></a></td>
               <td><a href="faculty_publishdocument_cancel.jsp?docid=<%=docid%>"><img src="images/Delete-icon.png" style="width:20px;"border="0" title="cancel" /></a></td>
