  ...
  <section class="hoc container clear">
    <div class="points group"> 
      ...
      <div class="sectiontitle">
        ...
        <h1 class ="heading font-x3">Approve Publication</h1>
      </div>
          <center>
	...
	<div class="row">
        ...
        <div class="col-md-6">
        	<form class="form-horizontal" role="form" method="get" action="approve_publishdetail.jsp" >
              
        <div class="form-group">
                  <label class="control-label col-sm-4" for="email">Choose User Type:</label>
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-offset-4 col-sm-2">
                     <input type="submit" class="btn btn-success" name="Register" value="View Publication Requests" style="cursor:pointer;" />
                  </div>
                </div>
